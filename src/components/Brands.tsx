...
const Brands = () => {
  return (
    <section className="px-16 py-10">
      ...
      <main className="flex pt-32 justify-between">
        <div className="flex-[0.7] ">
          ...
          <button className="w-[40%] text-white bg-gradient-to-r mt-8   from-[#5e11ff]  via-[#b5497c]   to-[#ee6e26]  flex justify-center items-center gap-3 py-4 rounded-3xl">
